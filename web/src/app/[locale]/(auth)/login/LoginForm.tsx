    ...
    <div className="flex min-h-screen items-center justify-center p-8">
      <div className="w-full max-w-sm space-y-6">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div>
            <label htmlFor="email" className="block text-sm font-medium">{tc('email')}</label>
            <input
              id="email"
              type="email"
              value={email}
          ...
          <div>
            <label htmlFor="password" className="block text-sm font-medium">{tc('password')}</label>
            <input
              id="password"
              type="password"
              value={password}
        ...
        <p className="text-center text-sm text-muted-foreground">
          {t('noAccount')}{' '}
          <Link href="/signup" className="font-medium text-foreground underline">{tc('signUp')}</Link>
        </p>
        <p className="text-center text-xs text-muted-foreground/60">
          {t('agreeTo')}{' '}
          <Link href="/terms" target="_blank" rel="noopener noreferrer" className="underline underline-offset-2 hover:text-muted-foreground transition-colors">{t('termsOfService')}</Link>
          {' '}{t('and')}{' '}
          <Link href="/privacy" target="_blank" rel="noopener noreferrer" className="underline underline-offset-2 hover:text-muted-foreground transition-colors">{t('privacyPolicy')}</Link>.
        </p>
      </div>
    </div>
  )
